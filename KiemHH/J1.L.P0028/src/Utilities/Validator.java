...
public final class Validator {
    private static final Pattern CUSTOMER_CODE = Pattern.compile("^[CGK]\\d{4}$", Pattern.CASE_INSENSITIVE);
    private static final Pattern EMAIL = Pattern.compile("^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$");
    private static final Pattern VIETNAMESE_PHONE = Pattern.compile("^(03[2-9]|05[2689]|07[06-9]|08[1-9]|09[0-9])\\d{7}$");
