...
public final class Messages {
    ...
    public static final String ERR_INVALID_NUMBER = "Invalid input! Please enter a valid number.";
    ...
    public static final String MSG_SEARCH_TABLE_HEADER = "%-20s | %-10s | %-15s%n";
    public static final String MSG_SEARCH_TABLE_ROW = "%-20s | %-10s | %-15s%n";
