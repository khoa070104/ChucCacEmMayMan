...
public final class Messages {
    ...
    public static final String ERR_INVALID_NUMBER = "Invalid input! Please enter a number.";
    ...
    public static final String ERR_INVALID_PRICE = "Invalid price! Must be a positive number.";
    ...
    public static final String ERR_DUP_FRUIT_ID = "Fruit ID already exists! Please use another ID.";
    ...
    public static final String ERR_NO_FRUITS = "No fruits available. Please create fruits first.";
    public static final String ERR_OUT_OF_STOCK = "All fruits are out of stock.";
    public static final String ERR_INVALID_SHOPPING_ITEM = "Invalid selection or out of stock!";
    public static final String ERR_NO_FRUITS_CREATED = "\nNo fruits created yet.";
    public static final String ERR_NO_ORDERS = "\nNo orders yet.";
    public static final String ERR_INVALID_MENU_CHOICE = "Invalid choice! Please select 1 to 4.";

    public static final String MSG_PROGRAM_EXIT = "Thank you for using Fruit Shop System!";
    ...
    public static final String ERR_INVALID_ITEM_RANGE = "Invalid item! Please select from 1 to ";
}
