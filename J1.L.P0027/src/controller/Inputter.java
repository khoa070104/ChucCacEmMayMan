...
public class Inputter { // Nhập dữ liệu - Class tính năng
    ...
    public static final String PHONE_NUMBER_VALIDATE =
            "^(03[2-9]|05[6|8|9]|07[0|6-9]|08[1-5]|09\\d)\\d{7}$";
    public static final String EMAIL_VALIDATE = "^[\\w.-]+@[a-zA-Z\\d.-]+\\.[a-zA-Z]{2,}$";
    public static final String MOUNTAIN_CODE_VALIDATE = "^[\\d]$";
    public static final String TUTION_FEE_VALIDATE =
            "^(03[2-9]|086|09[6-8]|08[1-5]|088|09[14])\\d{7}$";
