...
public class StudentController {
    ...
    public void addNewRegistration() {
        ...
        phoneNumber =
                Inputter.inputRequired("Enter phone number: ", Inputter.PHONE_NUMBER_VALIDATE);
        email = Inputter.inputRequired("Enter email: ", Inputter.EMAIL_VALIDATE);
        do {
            mountainCode =
                    Inputter.inputRequired(
                            "Enter mountain code: ", Inputter.MOUNTAIN_CODE_VALIDATE);
        ...
        Student newStudent =
                new Student(studentId, name, phoneNumber, email, mountainCode, tutionFee);
            ...
            while (true) {
                moutainCode =
                        Inputter.inputOptional(
                                "Enter new mountain code: ", Inputter.MOUNTAIN_CODE_VALIDATE);
                if (moutainCode.isEmpty() || moutainCode == "") break;
    ...
    public static void main(String[] args) {
        ...
        controller.listStudent.add(
                new Student("QE190000", "ALIBBA", "0322222222", "email@gmail.com", "1", 6000000));
        controller.listStudent.add(
                new Student("QE190001", "ALIBBA", "0322222222", "email@gmail.com", "1", 600000));
        controller.listStudent.add(
                new Student("QE190002", "ALIBBA", "0322222222", "email@gmail.com", "2", 600000));
        controller.listStudent.add(
                new Student("DE190000", "ALIBBA", "0322222222", "email@gmail.com", "1", 600000));
    ...
    public void deleteRegister() {
        ...
        studentId =
                Inputter.inputRequired(
                        "Enter student id to remove: ", Inputter.STUDENT_ID_VALIDATE);
        Student std = getStudentById(studentId);
        if (std == null) {
            System.out.println("This student has not registered yet.");
        } else {
    ...
    public void printStatist() {
        ...
        System.out.println("--------------------------------------------------------------");
        System.out.printf(
                "%-10s | %-22s | %-15s%n", "Peak Name", "Number of Participants", "Total Cost");
        System.out.println("--------------------------------------------------------------");
        for (String code : mountainCodeList) {
            ...
            System.out.printf(
                    "%-10s | %-22d | %,-15.0f%n",
                    convertMountainCode(code), numberOfParticipant, totalCost);
        }
        System.out.println("--------------------------------------------------------------");
    }
