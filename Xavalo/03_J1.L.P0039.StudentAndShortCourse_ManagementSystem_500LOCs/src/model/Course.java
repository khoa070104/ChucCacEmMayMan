...
public class Course {
    ...
    public Course(String id, String studentId, String name, int durationWeeks, LocalDate startDate) {
        ...
        this.durationWeeks = durationWeeks; this.startDate = startDate;
    }
    ...
    public String toFileLine() { return String.format("%s, %s, %s, %d, %s", id, studentId, name, durationWeeks, startDate.format(DATE_FORMAT)); }
}
