...
/**
 * Main Class dùng để chạy chương trình LinearSearch.
 *
 * @version 27/05/2026
 */
public class Main {
        ...
        try {
            ...
            int key =
                    Validator.getInt(
                            ...
                            Integer.MIN_VALUE,
                            Integer.MAX_VALUE);
            // Bước 5: Hiển thị mảng đã được sinh ngẫu nhiên ra màn hình.
            System.out.print("The array: ");
            myArray.display();

            // Bước 6: Tìm kiếm tuyến tính giá trị cần tìm trong mảng và hiển thị kết quả tìm kiếm.
            int index = myArray.linearSearch(key);
